...
def MCTS(root, verbose = False):
    ...
    while time.time()<=run_time:
        ...
        node_index,rdock_score,valid_smile= check_node_type(new_compound, back_name)
...
def UCTchemical():
    ...
    time_out=one_search_start_time+60*60*72
    state = chemical()
